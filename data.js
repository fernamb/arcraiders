const BENCHES = [
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 2, items: [
        ...
        { name: 'Durable Cloth', qty: 5 },
        { name: 'Tick Pod', qty: 8 },
      ]},
      { level: 3, items: [
        { name: 'Rusted Shut Medical Kit', qty: 3 },
        { name: 'Antiseptic', qty: 8 },
        { name: 'Surveyor Vault', qty: 5 },
      ]},
    ],
  },
  {
    ...
    levels: [
      ...
      { level: 2, items: [
        { name: 'Toaster', qty: 3 },
        { name: 'ARC Motion Core', qty: 5 },
        { name: 'Fireball Burner', qty: 8 },
      ]},
      { level: 3, items: [
        { name: 'Motor', qty: 3 },
        { name: 'ARC Circuitry', qty: 10 },
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 2, items: [
        { name: 'Damaged Heat Sink', qty: 2 },
        { name: 'Electrical Components', qty: 5 },
        { name: 'Snitch Scanner', qty: 6 },
      ]},
      { level: 3, items: [
        { name: 'Fried Motherboard', qty: 3 },
        { name: 'Advanced Electrical Components', qty: 5 },
        { name: 'Leaper Pulse Unit', qty: 4 },
      ]},
    ],
  },
];
